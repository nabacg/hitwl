...
reagent.impl.batching.next_tick = ((cljs.core.not.call(null,reagent.impl.util.is_client))?reagent.impl.batching.fake_raf:(function (){var w = window;var or__3052__auto__ = w.requestAnimationFrame;if(cljs.core.truth_(or__3052__auto__))
{return or__3052__auto__;
} else
{var or__3052__auto____$1 = w.webkitRequestAnimationFrame;if(cljs.core.truth_(or__3052__auto____$1))
{return or__3052__auto____$1;
} else
{var or__3052__auto____$2 = w.mozRequestAnimationFrame;if(cljs.core.truth_(or__3052__auto____$2))
{return or__3052__auto____$2;
} else
{var or__3052__auto____$3 = w.msRequestAnimationFrame;if(cljs.core.truth_(or__3052__auto____$3))
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__3619__auto__,writer__3620__auto__,opt__3621__auto__){return cljs.core._write.call(null,writer__3620__auto__,"reagent.impl.batching/RenderQueue");
});
...
reagent.impl.batching.is_reagent_component = (function is_reagent_component(C){var and__3040__auto__ = !((C == null));if(and__3040__auto__)
{var and__3040__auto____$1 = (C["props"]);if(cljs.core.truth_(and__3040__auto____$1))
