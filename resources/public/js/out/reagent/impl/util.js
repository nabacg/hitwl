...
{var name_str = cljs.core.name.call(null,dashed);var vec__5945 = clojure.string.split.call(null,name_str,/-/);var start = cljs.core.nth.call(null,vec__5945,(0),null);var parts = cljs.core.nthnext.call(null,vec__5945,(1));if(cljs.core.truth_(reagent.impl.util.dont_camel_case.call(null,start)))
{return name_str;
} else
...
reagent.impl.util.partial_ifn.cljs$lang$ctorPrWriter = (function (this__3619__auto__,writer__3620__auto__,opt__3621__auto__){return cljs.core._write.call(null,writer__3620__auto__,"reagent.impl.util/partial-ifn");
});
...
var G__5947__delegate = function (self__,a){var self____$1 = this;var _ = self____$1;var or__3052__auto___5948 = self__.p;if(cljs.core.truth_(or__3052__auto___5948))
{} else
{self__.p = cljs.core.apply.call(null,cljs.core.partial,self__.f,self__.args);
}
return cljs.core.apply.call(null,self__.p,a);
};
var G__5947 = function (self__,var_args){
var self__ = this;
var a = null;if (arguments.length > 1) {
  a = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return G__5947__delegate.call(this,self__,a);};
G__5947.cljs$lang$maxFixedArity = 1;
G__5947.cljs$lang$applyTo = (function (arglist__5949){
var self__ = cljs.core.first(arglist__5949);
var a = cljs.core.rest(arglist__5949);
return G__5947__delegate(self__,a);
});
G__5947.cljs$core$IFn$_invoke$arity$variadic = G__5947__delegate;
return G__5947;
})()
;
reagent.impl.util.partial_ifn.prototype.apply = (function (self__,args5946){var self__ = this;
var self____$1 = this;return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone.call(null,args5946)));
});
reagent.impl.util.partial_ifn.prototype.cljs$core$IFn$_invoke$arity$2 = (function() { 
var G__5950__delegate = function (a){var _ = this;var or__3052__auto___5951 = self__.p;if(cljs.core.truth_(or__3052__auto___5951))
{} else
{self__.p = cljs.core.apply.call(null,cljs.core.partial,self__.f,self__.args);
}
return cljs.core.apply.call(null,self__.p,a);
};
var G__5950 = function (var_args){
var self__ = this;
var a = null;if (arguments.length > 0) {
  a = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return G__5950__delegate.call(this,a);};
G__5950.cljs$lang$maxFixedArity = 0;
G__5950.cljs$lang$applyTo = (function (arglist__5952){
var a = cljs.core.seq(arglist__5952);
return G__5950__delegate(a);
});
...
reagent.impl.util.clj_ifn_QMARK_ = (function clj_ifn_QMARK_(x){var or__3052__auto__ = cljs.core.ifn_QMARK_.call(null,x);if(or__3052__auto__)
{return or__3052__auto__;
} else
{var G__5956 = x;if(G__5956)
{var bit__3702__auto__ = (G__5956.cljs$lang$protocol_mask$partition1$ & (256));if((bit__3702__auto__) || (G__5956.cljs$core$IMultiFn$))
{return true;
} else
{if((!G__5956.cljs$lang$protocol_mask$partition1$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IMultiFn,G__5956);
} else
{return false;
}
}
...
reagent.impl.util._not_found = (function (){var obj5958 = {};return obj5958;
})();
...
reagent.impl.util.shallow_equal_maps = (function shallow_equal_maps(x,y){var or__3052__auto__ = (x === y);if(or__3052__auto__)
{return or__3052__auto__;
} else
{var and__3040__auto__ = cljs.core.map_QMARK_.call(null,x);if(and__3040__auto__)
{var and__3040__auto____$1 = cljs.core.map_QMARK_.call(null,y);if(and__3040__auto____$1)
{var and__3040__auto____$2 = (cljs.core.count.call(null,x) === cljs.core.count.call(null,y));if(and__3040__auto____$2)
{return cljs.core.reduce_kv.call(null,((function (and__3040__auto____$2,and__3040__auto____$1,and__3040__auto__,or__3052__auto__){
return (function (res,k,v){var yv = cljs.core.get.call(null,y,k,reagent.impl.util._not_found);if(cljs.core.truth_((function (){var or__3052__auto____$1 = (v === yv);if(or__3052__auto____$1)
{return or__3052__auto____$1;
} else
{var or__3052__auto____$2 = reagent.impl.util.identical_ish_QMARK_.call(null,v,yv);if(or__3052__auto____$2)
{return or__3052__auto____$2;
} else
{var and__3040__auto____$3 = cljs.core.keyword_identical_QMARK_.call(null,k,new cljs.core.Keyword(null,"style","style",-496642736));if(and__3040__auto____$3)
...
});})(and__3040__auto____$2,and__3040__auto____$1,and__3040__auto__,or__3052__auto__))
,true,x);
} else
...
var or__3052__auto__ = (v1 === v2);if(or__3052__auto__)
{return or__3052__auto__;
} else
{var and__3040__auto__ = (cljs.core.count.call(null,v1) === cljs.core.count.call(null,v2));if(and__3040__auto__)
{return cljs.core.reduce_kv.call(null,((function (and__3040__auto__,or__3052__auto__){
return (function (res,k,v){var v_SINGLEQUOTE_ = cljs.core.nth.call(null,v2,k);if(cljs.core.truth_((function (){var or__3052__auto____$1 = (v === v_SINGLEQUOTE_);if(or__3052__auto____$1)
{return or__3052__auto____$1;
} else
{var or__3052__auto____$2 = reagent.impl.util.identical_ish_QMARK_.call(null,v,v_SINGLEQUOTE_);if(or__3052__auto____$2)
{return or__3052__auto____$2;
} else
{var and__3040__auto____$1 = cljs.core.map_QMARK_.call(null,v);if(and__3040__auto____$1)
...
});})(and__3040__auto__,or__3052__auto__))
,true,v1);
} else
{return and__3040__auto__;
}
