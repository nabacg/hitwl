...
goog.require('goog.events');
clojure.browser.event.IEventType = (function (){var obj7616 = {};return obj7616;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__3040__auto__ = this$;if(and__3040__auto__)
...
{var x__3679__auto__ = (((this$ == null))?null:this$);return (function (){var or__3052__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__3679__auto__)]);if(or__3052__auto__)
{return or__3052__auto__;
} else
{var or__3052__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__3052__auto____$1)
...
return (function (p__7617){var vec__7618 = p__7617;var k = cljs.core.nth.call(null,vec__7618,(0),null);var v = cljs.core.nth.call(null,vec__7618,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__7619){var vec__7620 = p__7619;var k = cljs.core.nth.call(null,vec__7620,(0),null);var v = cljs.core.nth.call(null,vec__7620,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
