...
reagent_forms.datepicker.blank_date = (function blank_date(){var G__7333 = (new Date());G__7333.setHours((0));
G__7333.setMinutes((0));
G__7333.setSeconds((0));
G__7333.setMilliseconds((0));
return G__7333;
});
...
reagent_forms.datepicker.format_date = (function format_date(p__7351,p__7352){var map__7355 = p__7351;var map__7355__$1 = ((cljs.core.seq_QMARK_.call(null,map__7355))?cljs.core.apply.call(null,cljs.core.hash_map,map__7355):map__7355);var day = cljs.core.get.call(null,map__7355__$1,new cljs.core.Keyword(null,"day","day",-274800446));var month = cljs.core.get.call(null,map__7355__$1,new cljs.core.Keyword(null,"month","month",-1960248533));var year = cljs.core.get.call(null,map__7355__$1,new cljs.core.Keyword(null,"year","year",335913393));var map__7356 = p__7352;var map__7356__$1 = ((cljs.core.seq_QMARK_.call(null,map__7356))?cljs.core.apply.call(null,cljs.core.hash_map,map__7356):map__7356);var parts = cljs.core.get.call(null,map__7356__$1,new cljs.core.Keyword(null,"parts","parts",849007691));var separator = cljs.core.get.call(null,map__7356__$1,new cljs.core.Keyword(null,"separator","separator",-1628749125));return clojure.string.join.call(null,separator,cljs.core.map.call(null,((function (map__7355,map__7355__$1,day,month,year,map__7356,map__7356__$1,parts,separator){
return (function (p1__7350_SHARP_){if(cljs.core.truth_(cljs.core.some.call(null,cljs.core.PersistentHashSet.fromArray([p1__7350_SHARP_], true),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"d","d",1972142424),new cljs.core.Keyword(null,"dd","dd",-1340437629)], null))))
{return reagent_forms.datepicker.formatted_value.call(null,day);
} else
{if(cljs.core.truth_(cljs.core.some.call(null,cljs.core.PersistentHashSet.fromArray([p1__7350_SHARP_], true),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"m","m",1632677161),new cljs.core.Keyword(null,"mm","mm",-1652850560)], null))))
{return reagent_forms.datepicker.formatted_value.call(null,month);
} else
{if(cljs.core._EQ_.call(null,p1__7350_SHARP_,new cljs.core.Keyword(null,"yy","yy",-1432012814)))
{return (''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(year)).substring((2));
} else
{if(cljs.core._EQ_.call(null,p1__7350_SHARP_,new cljs.core.Keyword(null,"yyyy","yyyy",2098225339)))
{return year;
} else
{return null;
}
...
});})(map__7355,map__7355__$1,day,month,year,map__7356,map__7356__$1,parts,separator))
,parts));
});
reagent_forms.datepicker.first_day_of_week = (function first_day_of_week(year,month){return (function (){var G__7358 = (new Date());G__7358.setYear(year);
G__7358.setMonth(month);
G__7358.setDate((1));
return G__7358;
})().getDay();
});
reagent_forms.datepicker.gen_days = (function gen_days(p__7359,get,save_BANG_){var vec__7365 = p__7359;var year = cljs.core.nth.call(null,vec__7365,(0),null);var month = cljs.core.nth.call(null,vec__7365,(1),null);var num_days = reagent_forms.datepicker.days_in_month.call(null,year,month);var last_month_days = (((month > (0)))?reagent_forms.datepicker.days_in_month.call(null,year,(month - (1))):null);var first_day = reagent_forms.datepicker.first_day_of_week.call(null,year,month);return cljs.core.map.call(null,((function (num_days,last_month_days,first_day,vec__7365,year,month){
...
});})(num_days,last_month_days,first_day,vec__7365,year,month))
,cljs.core.partition.call(null,(7),(function (){var iter__3777__auto__ = ((function (num_days,last_month_days,first_day,vec__7365,year,month){
return (function iter__7366(s__7367){return (new cljs.core.LazySeq(null,((function (num_days,last_month_days,first_day,vec__7365,year,month){
return (function (){var s__7367__$1 = s__7367;while(true){
var temp__4126__auto__ = cljs.core.seq.call(null,s__7367__$1);if(temp__4126__auto__)
{var s__7367__$2 = temp__4126__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__7367__$2))
{var c__3775__auto__ = cljs.core.chunk_first.call(null,s__7367__$2);var size__3776__auto__ = cljs.core.count.call(null,c__3775__auto__);var b__7369 = cljs.core.chunk_buffer.call(null,size__3776__auto__);if((function (){var i__7368 = (0);while(true){
if((i__7368 < size__3776__auto__))
{var i = cljs.core._nth.call(null,c__3775__auto__,i__7368);cljs.core.chunk_append.call(null,b__7369,(((i < first_day))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td.day.old","td.day.old",1008935029),(cljs.core.truth_(last_month_days)?(last_month_days - ((first_day - i) - (1))):null)], null):(((i < (first_day + num_days)))?(function (){var day = ((i - first_day) + (1));var date = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"year","year",335913393),year,new cljs.core.Keyword(null,"month","month",-1960248533),month,new cljs.core.Keyword(null,"day","day",-274800446),day], null);return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td.day","td.day",-943475874),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var temp__4126__auto____$1 = get.call(null);if(cljs.core.truth_(temp__4126__auto____$1))
...
})(),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__7368,day,date,i,c__3775__auto__,size__3776__auto__,b__7369,s__7367__$2,temp__4126__auto__,num_days,last_month_days,first_day,vec__7365,year,month){
...
});})(i__7368,day,date,i,c__3775__auto__,size__3776__auto__,b__7369,s__7367__$2,temp__4126__auto__,num_days,last_month_days,first_day,vec__7365,year,month))
], null),day], null);
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__7369),iter__7366.call(null,cljs.core.chunk_rest.call(null,s__7367__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__7369),null);
}
} else
{var i = cljs.core.first.call(null,s__7367__$2);return cljs.core.cons.call(null,(((i < first_day))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td.day.old","td.day.old",1008935029),(cljs.core.truth_(last_month_days)?(last_month_days - ((first_day - i) - (1))):null)], null):(((i < (first_day + num_days)))?(function (){var day = ((i - first_day) + (1));var date = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"year","year",335913393),year,new cljs.core.Keyword(null,"month","month",-1960248533),month,new cljs.core.Keyword(null,"day","day",-274800446),day], null);return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td.day","td.day",-943475874),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var temp__4126__auto____$1 = get.call(null);if(cljs.core.truth_(temp__4126__auto____$1))
{var doc_date = temp__4126__auto____$1;if(cljs.core._EQ_.call(null,doc_date,date))
{return "active";
} else
{return null;
...
})(),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (day,date,i,s__7367__$2,temp__4126__auto__,num_days,last_month_days,first_day,vec__7365,year,month){
return (function (){if(cljs.core._EQ_.call(null,get.call(null),date))
{return save_BANG_.call(null,null);
} else
{return save_BANG_.call(null,date);
}
});})(day,date,i,s__7367__$2,temp__4126__auto__,num_days,last_month_days,first_day,vec__7365,year,month))
], null),day], null);
})():new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td.day.new","td.day.new",500967295),(((month < (11)))?((i - (first_day + num_days)) + (1)):null)], null)
)),iter__7366.call(null,cljs.core.rest.call(null,s__7367__$2)));
}
} else
{return null;
}
...
reagent_forms.datepicker.last_date = (function last_date(p__7371){var vec__7373 = p__7371;var year = cljs.core.nth.call(null,vec__7373,(0),null);var month = cljs.core.nth.call(null,vec__7373,(1),null);if((month > (0)))
...
reagent_forms.datepicker.next_date = (function next_date(p__7374){var vec__7376 = p__7374;var year = cljs.core.nth.call(null,vec__7376,(0),null);var month = cljs.core.nth.call(null,vec__7376,(1),null);if(cljs.core._EQ_.call(null,month,(11)))
